...
class A2ASpringBootMvcControllerTest {
    ...
    private final org.springframework.beans.factory.ObjectProvider<StreamingSubscriptionObserver> streamingSubscriptionObserver =
            new org.springframework.beans.factory.support.StaticListableBeanFactory().getBeanProvider(StreamingSubscriptionObserver.class);
    ...
    void servesNotModifiedAgentCardWhenEtagMatches() {
        ...
        ResponseEntity<?> response = controller.getAgentCard(httpRequest(Map.of(
                "If-None-Match", List.of(etag))));
    ...
    void servesNotModifiedAgentCardWhenIfModifiedSinceMatches() {
        ...
        ResponseEntity<?> response = controller.getAgentCard(httpRequest(Map.of(
                "If-Modified-Since", List.of(lastModified))));
