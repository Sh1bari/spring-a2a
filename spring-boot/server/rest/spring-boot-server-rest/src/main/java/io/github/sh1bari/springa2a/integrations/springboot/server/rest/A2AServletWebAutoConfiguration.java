...
import io.github.sh1bari.springa2a.integrations.springboot.server.autoconfigure.A2ARuntimeAutoConfiguration;
...
public class A2AServletWebAutoConfiguration {
    ...
    public A2ASpringBootMvcController a2aSpringBootMvcController(
            @Qualifier("agentCard") AgentCard agentCard,
            @Qualifier("extendedAgentCard") ObjectProvider<AgentCard> extendedAgentCard,
            ObjectProvider<A2ASpringBootProperties> properties,
        ...
        return new A2ASpringBootMvcController(
                agentCard,
                extendedAgentCard.getIfAvailable(),
                properties.getIfAvailable(A2ASpringBootProperties::new),
                requestHandler,
                responseMapper,
