...
import io.github.sh1bari.springa2a.integrations.springboot.server.autoconfigure.A2ASpringBootProperties;
...
public class A2ASpringBootMvcController {
    ...
    public A2ASpringBootMvcController(AgentCard agentCard,
            @Nullable AgentCard extendedAgentCard,
            A2ASpringBootProperties properties,
    ...
    private AgentCardResponseMetadata createAgentCardResponseMetadata(String agentCardJson) {
        ...
        return new AgentCardResponseMetadata(agentCardJson, Map.of(
    ...
    private boolean isNotModified(HttpServletRequest request, AgentCardResponseMetadata metadata) {
        ...
        try {
            Instant clientTimestamp = DateTimeFormatter.RFC_1123_DATE_TIME
