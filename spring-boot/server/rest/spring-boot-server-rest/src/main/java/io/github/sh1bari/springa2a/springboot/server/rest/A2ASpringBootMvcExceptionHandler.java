 ...
 *
 * <p>
 * This handler translates protocol and parsing errors into the A2A JSON error envelope
 * rather than letting Spring Boot fall back to its default error response format.
 */
