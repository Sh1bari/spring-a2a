package io.github.sh1bari.springa2a.springboot.server.tck.rest;
...
@Component
public class SpringBootRestTckSutAgentExecutor implements AgentExecutor {
	...
	public void execute(RequestContext context, AgentEmitter emitter) throws A2AError {
		...
		if (messageId.startsWith("tck-stream-artifact-file")) {
			emitter.startWork();
			emitter.addArtifact(List.of(new FilePart(new FileWithBytes("text/plain", "output.txt", "dGNr"))), null,
					null, null);
			emitter.complete();
			return;
		}
