...
public record SpringBootRestClientFullFlowResponse(boolean success, String serverUrl, AgentCard agentCard,
		SpringBootRestClientScenarioResponse blocking, SpringBootRestClientScenarioResponse streaming,
		String errorMessage) {

	public static SpringBootRestClientFullFlowResponse success(String serverUrl, AgentCard agentCard,
			SpringBootRestClientScenarioResponse blocking, SpringBootRestClientScenarioResponse streaming) {
